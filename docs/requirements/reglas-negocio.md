# REGLAS DE NEGOCIO
En base a las entrevista que se hicieron a los 3 usuarios se concluyeron las siguientes reglas de negocio :
...
- **RN-03 :** Los cursos de especialidad (de la carrera de ing. de Sistemas e Informática) se puede que dictar las horas de teoría en otras aulas (de preferencia en el pabellon I)
...
- **RN-05 :** La disponibilidad declarada por el docente debe corresponder a periodos de tiempo en los que puede ser programado para dictar clases(mañana, tarde o noche).
...
- **RN-07 :** La cantidad de horas programadas para un docente debe considerar la carga horaria correspondiente a los cursos que tiene asignados.
